...
********* */
        System.out.printin("A well-formed java program has a main method with { and } brances,\n A System.out.println statement has ( and ) and usually a String that starts and ends with a \" character.\n(But we type \" instead!)\nWhat is the difference between\na ' and a \"?  Or between a \" and a \"?One is what we see when we're typing our program.\n The other is what appears on the \"console.\"");
